  ...
  render() {
          ...
          if (details.image != "")
            return (
              <>
                <Image
                  width={70}
                  src={`${REACT_APP_API_URL}${details.image[0].photo}`}
                />
              </>
            );
          else {
    ...
    return (
      <Table
        ...
        //         <Table.Summary.Cell className="ant_right">
        //           <Text>
        //             <b>{formatter.format(total_data['current_purchase_price'])}</b>
        //           </Text>
        //         </Table.Summary.Cell>
        //         <Table.Summary.Cell className="ant_right">
        //           <Text>
        //             <b>{formatter.format(total_data['current_selling_price'])}</b>
        //           </Text>
        //         </Table.Summary.Cell>
        ...
        //         <Table.Summary.Cell className="ant_right">
        //           <Text>
        //             <b>{formatter.format(total_data['total_purchase_price'])}</b>
        //           </Text>
        //         </Table.Summary.Cell>
        //         <Table.Summary.Cell className="ant_right">
        //           <Text>
