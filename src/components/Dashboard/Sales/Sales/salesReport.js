              ...
              <div className="site-card-wrapper">
                  ...
                  <Col span={9} offset={1}>
                    <Row>
                      ...
                      <Col span={8}>
                        ...
                        >
                          <h3 style={{ color: "white" }}>VAT</h3>
                          {total_tax.current} BDT
                        </Card>
                      </Col>
                    </Row>
                    <Row gutter={16}>
                ...
                {/* <Row>
                  <Col
                    ...
                    span={24}
                  >
                    <Linechart data={data} xField="issue_date" yField="bill" />

                    <DemoDualAxes data1={data1} data2={data1} />
                  </Col>
                </Row> */}
              </div>
              <Divider />
